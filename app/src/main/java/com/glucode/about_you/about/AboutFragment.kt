...
class AboutFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val profileView = layoutInflater.inflate(R.layout.profile_design, null)

        // Add the profile view to the container layout
        binding.container.addView(profileView, 0)
